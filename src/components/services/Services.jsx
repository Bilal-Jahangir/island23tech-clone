...
const Services = () => {
      ...
      packages: [
        {
          name: 'Starter Package',
          features: [
            'Logo design or single promotional graphic.',
          ],
        },
        {
  ...
  return (
      ...
      <div className="max-w-5xl w-full">
        ...
        <div className="mb-3">
          ...
          <p className="mt-4 md:mt-6 text-[18px] md:text-[20px] text-neutral-300 max-w-5xl">
            Your One-Stop Solution Hub: Where Innovation Meets Service Excellence Across a Spectrum of Business Needs!
          </p>
        </div>
    ...
    <div className="min-h-screen  text-white p-8 font-sans"> {/* Adjusted background color */}
      {/* Tab Buttons */}
    ...
    <div className="bg-[#000222] text-white py-8 md:py-16 font-sans min-h-[50vh] flex">
      <div className="max-w-4xl mx-auto md:pr-40">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-4">
          Discover the{' '}
          <span className="text-[#00c2ff]">right</span><br />
          <span className="text-[#00C2FF]">solution</span> for your business
        </h1>

        {/* Subtitle */}
        <p className="text-gray-300 text-base md:text-lg mb-8 max-w-2xl">
          Whether you need help with a platform/business strategy, an in-flight
          project, or need a talented consultant to bridge critical gaps,
          ISLAND 23 TECHNOLOGIES is here to help
        </p>
