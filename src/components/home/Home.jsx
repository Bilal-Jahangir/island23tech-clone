  ...
  return (
    <>
      ...
      <div className="relative h-[75vh] md:h-screen z-0 flex pt-10 md:pt-0 items-start md:items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 p-6 sm:p-8 md:p-12 lg:p-60 flex flex-col items-center justify-center space-y-6">
          {/* Main Title */}
          <h1
            data-aos="slide-right"
            className="text-white  px-5 font-bold text-2xl sm:text-5xl md:text-[54px] leading- tracking- drop-shadow-md"
          >
      ...
      <div className="relative min-h-[75vh] flex items-center justify-start text-left overflow-hidden">
        ...
        {/* Content Container (Text and Button) */}
        <div className="relative z-10 p-0 px-5 md:px-30 flex flex-col items-start justify-center space-y-6 max-w-[70%] md:max-w-[50%]">
          {/* Main Title */}
          <h1
            data-aos="slide-right"
            className="text-white font-bold text-xl md:text-4xl leading-tight tracking-tight  max-w-100 drop-shadow-md"
          >
      ...
      <div style={backgroundStyle} className={`md:h-[150vh] relative overflow-hidden`}>
        <ParticleBg/>
        <div className=" text-white px-4 py-15 md:px-45  flex flex-col items-center justify-center">
          <p 
          data-aos='slide-left'
          className="font-bold text-[16px] md:text-2xl   text-center">
           ...
           <button className="mt-4 z-10 md:mt-8 px-5 md:px-5 py-3 font-semibold  text-[14px]  text-white bg-gradient-to-r from-[#00cdff] to-[#0012fd] rounded-full shadow-lg hover:from-[#0012fd] hover:to-[#0012fd] transition-colors duration-700 ease-out">
            HOW WE WORK
          </button>
        </div>
